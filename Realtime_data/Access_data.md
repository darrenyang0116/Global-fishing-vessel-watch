In the [previous step](Choose_data.md), we choose [My Ship Tracking](http://www.myshiptracking.com/) to pull our dataset. Now we need to get access to the dataset and use in our code.
